...
if __name__ == '__main__':
    ...
    parser.add_argument('-l', '--left_imgs', help="path to all first (left) frames", default="/root/code/python/StereoMatch/StereoAlgorithms/test/MonSter/rect_left.png")
    parser.add_argument('-r', '--right_imgs', help="path to all second (right) frames", default="/root/code/python/StereoMatch/StereoAlgorithms/test/MonSter/rect_right.png")
