...
def inference(left_img:np.ndarray, right_img:np.ndarray, args:argparse.Namespace):
    ...
    with torch.no_grad():
        ...
        print("warm up for model")
        for _ in range(20):
            model(left_rected, right_rected, iters=args.valid_iters, test_mode=True)
...
if __name__ == '__main__':
    ...
    parser.add_argument("--left_img","-l",default=r"/mnt/d/dataset/CameraCalib/stereoexample_github/stereoexample_zed/test/1280/left/Explorer_HD720_SN21067_21-47-35.jpg")
    parser.add_argument("--right_img","-r",default=r"/mnt/d/dataset/CameraCalib/stereoexample_github/stereoexample_zed/test/1280/right/Explorer_HD720_SN21067_21-47-35.jpg")
