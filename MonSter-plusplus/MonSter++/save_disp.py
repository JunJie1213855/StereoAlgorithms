...
if __name__ == '__main__':
    ...
    parser.add_argument('--restore_ckpt', help="restore checkpoint", default="pretrained/Mix_all_large.pth")

    parser.add_argument('--save_numpy', action='store_true', help='save output as numpy arrays')
    parser.add_argument('-l', '--left_imgs', help="path to all first (left) frames", default="/root/code/python/StereoMatch/StereoAlgorithms/MonSter-plusplus/RT-MonSter++/rect_left.png")
    parser.add_argument('-r', '--right_imgs', help="path to all second (right) frames", default="/root/code/python/StereoMatch/StereoAlgorithms/MonSter-plusplus/RT-MonSter++/rect_right.png")
