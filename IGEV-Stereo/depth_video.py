...
def main(args:argparse.Namespace):
    ...
    video_len = left_video.get(cv2.CAP_PROP_FRAME_COUNT)
    ## model
    # 模型
    ...
    model.eval()
    index = 0
    for i in tqdm(range(1,int(video_len))):
        # 视频读取
...
if __name__ == '__main__':
    ...
    parser.add_argument("--param_file",default="./param/data.yaml")
    parser.add_argument("-l","--left_video",default="E:\\dataset\\calibrate\\stereoMatch\\data\\left_1.avi")
    parser.add_argument("-r","--right_video",default="E:\\dataset\\calibrate\\stereoMatch\\data\\right_1.avi")
