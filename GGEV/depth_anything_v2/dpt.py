...
class DPTHead(nn.Module):
    ...
    def forward(self, out_features, patch_h, patch_w, only_feat=False):
        ...
        if only_feat:
            return [out, path_2, path_3, path_4]
        
        out_last = F.interpolate(out, (int(patch_h * 14), int(patch_w * 14)), mode="bilinear", align_corners=True)
        depth = self.scratch.output_conv2(out_last)
        
        return depth, [out, path_2, path_3, path_4]
