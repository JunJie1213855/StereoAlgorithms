...
def get_args_parser():
    ...
    parser.add_argument('--img_height', default=736, type=int,
                        help='image height')
    parser.add_argument('--img_width', default=1280, type=int,
                        help='image width')
    parser.add_argument("--onnx_path",
                        default="onnx_save/S2M2_S_1280_736_v2_torch29_sim.onnx",
...
def main(args):
    ...
    if args.allow_negative:
        ...
        left_path = 'rect_left.png'
        right_path = 'rect_right.png'
    ...
    left_torch = (torch.from_numpy(left).permute(-1, 0, 1).unsqueeze(0)).to('cuda:0')
    right_torch = (torch.from_numpy(right).permute(-1, 0, 1).unsqueeze(0)).to('cuda:0')
