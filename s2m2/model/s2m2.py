...
from .submodules import DispInitOnnx

class S2M2Onnx(nn.Module):
    def __init__(self,
                 feature_channels: int,
                 dim_expansion: int,
                 num_transformer: int,
        ...
        # Disparity matching using Optimal Transport
        self.disp_init = DispInitOnnx(dim=feature_channels, ot_iter=3, use_positivity=use_positivity)
